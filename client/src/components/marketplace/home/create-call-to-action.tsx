  ...
  return (
    <div className="mb-12 bg-linear-to-r  from-accent via-accent-fifthy to-accent-firthy rounded-sm h-[350px] p-6 lg:p-8 flex items-center justify-between relative">
      ...
      <div className="h-full w-full flex flex-col lg:justify-end items-start gap-y-4 z-10">
        <h2 className="text-3xl lg:text-7xl font-accent font-black tracking-widest">
          CREATE <br />
          YOUR PXL.
        </h2>
        <Button
      ...
      <img
        ...
        alt="PXL NFT EXAMPLE"
        className="size-36 lg:size-96 z-20 absolute lg:static right-0 bottom-0"
      />
      <img
        src="/assets/art-background-2.svg"
        alt="PXL NFT EXAMPLE"
        className="size-36 lg:size-80 absolute lg:opacity-30 bottom-0 left-0 lg:left-auto lg:right-1/5 z-10"
      />
    </div>
  );
}
